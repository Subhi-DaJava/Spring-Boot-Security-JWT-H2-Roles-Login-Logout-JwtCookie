package com.uyghurjava.spring.security.login.security.service;
 ...
 *
 * Note : If we want to get more data (id, email…), we can create an implementation of this "UserDetails" interface.
 *
